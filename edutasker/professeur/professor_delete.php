...
if (isset($cledelete))
{
    ...
    {
        require ("../connexion.php");
        $r = "delete from professor where ProfessorID ='" . $data['ProfessorID'] . "'";
        mysqli_query($con, $r);
        $r = "alter table professor auto_increment = 1";
        mysqli_query($con, $r);
