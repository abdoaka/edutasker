...
<body>
    <div class="main-panel">
        <div class="content">
        <form method="POST" action="management_confirm_a.php" enctype="multipart/form-data">
                <fieldset>
                    <legend>New management</legend>
                    ...
                    <div class="form-group">
                        <label for="disableinput">School</label>
